...
Establish a consistent and functional header across all pages of the Grupo Alfa website.
...
The header must match the reference image's layout and styling.
...
- **THEN** its link in the header must have a solid underline as seen in the reference image.
