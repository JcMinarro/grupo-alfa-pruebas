# Capability: Page Migration

## Purpose
Standardize the process of converting legacy static HTML pages into Astro components while preserving fidelity and improving URL structure.
